...
navViewCaseInfoHelper.prototype.editForm = function () {
    ...
    $("#_nav_view_case_info_div select.form-control-plaintext").removeClass("form-control-plaintext").addClass("custom-select").prop("readonly", false);
    $("#_nav_view_case_info_div textarea.form-control-plaintext").removeClass("form-control-plaintext").addClass("form-control").prop("readonly", false);
}
...
navViewCaseInfoHelper.prototype.makeFormReadOnly= function () {
    ...
    $("#_nav_view_case_info_div select.custom-select").removeClass("custom-select").addClass("form-control-plaintext").prop("readonly", true);
    $("#_nav_view_case_info_div textarea.form-control").removeClass("form-control").addClass("form-control-plaintext").prop("readonly", true);
}
